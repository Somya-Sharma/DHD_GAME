...
HD_PWD='C:/Users/Aamir/Desktop/project_versions/basePro_bramS2/basePro_bramS2.runs/lives_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lives.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lives.tcl
