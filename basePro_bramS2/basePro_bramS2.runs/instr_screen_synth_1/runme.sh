...
HD_PWD='C:/Users/Aamir/Desktop/project_versions/basePro_bramS2/basePro_bramS2.runs/instr_screen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instr_screen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instr_screen.tcl
